...
<html lang="en">
  ...
  <body class="app-body">
	...
	"authcrunch/portal": `<!doctype html>
<html lang="en">
  <head>
    <!-- This is experimental AuthCrunch template -->
    <title>{{ .Title }}</title>
  ...
  <body class="app-body">
	...
	"authcrunch/whoami": `<!doctype html>
<html lang="en">
  <head>
    <!-- This is experimental AuthCrunch template -->
    <title>{{ .Title }}</title>
  ...
  <body class="app-body">
	...
	"authcrunch/register": `<!doctype html>
<html lang="en">
  <head>
    <!-- This is experimental AuthCrunch template -->
    <title>{{ .Title }}</title>
  ...
  <body class="app-body">
	...
	"authcrunch/generic": `<!doctype html>
<html lang="en">
  <head>
    <!-- This is experimental AuthCrunch template -->
    <title>{{ .Title }}</title>
  ...
  <body class="app-body">
	...
	"authcrunch/settings": `<!doctype html>
<html lang="en">
  <head>
    <!-- This is experimental AuthCrunch template -->
    <title>{{ .Title }}</title>
...
function u2f_token_authenticate(formID, btnID) {
  ...
  authenticate_u2f_token(formID, btnID, params);
	...
	"authcrunch/sandbox": `<!doctype html>
<html lang="en">
  <head>
    <!-- This is experimental AuthCrunch template -->
    <title>{{ .Title }}</title>
