...
type Config struct {
	Local      *local.Config  `json:"local,omitempty" xml:"local,omitempty" yaml:"local,omitempty"`
	Ldap       *ldap.Config   `json:"ldap,omitempty" xml:"ldap,omitempty" yaml:"ldap,omitempty"`
	Saml       *saml.Config   `json:"saml,omitempty" xml:"saml,omitempty" yaml:"saml,omitempty"`
	OAuth2     *oauth2.Config `json:"oauth2,omitempty" xml:"oauth2,omitempty" yaml:"oauth2,omitempty"`
	authMethod AuthMethodType
}

// Backend is an authentication backend.
type Backend struct {
	Method AuthMethodType `json:"method,omitempty" xml:"method,omitempty" yaml:"method,omitempty"`
