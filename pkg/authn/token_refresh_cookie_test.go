...
func TestTokenRefreshCookieConfiguration(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{name: "invalid inherited name", cookies: &cookie.Config{RefreshTokenCookieName: "invalid name"}, wantError: "invalid cookie name"},
		{name: "invalid override", override: "invalid;name", wantError: "invalid cookie name"},
		...
		{name: "mixed-case host prefix at root", cookies: &cookie.Config{RefreshTokenCookieName: "__hOsT-REFRESH"}, mount: "/", want: "__hOsT-REFRESH"},
		{name: "mixed-case host access scoped path", cookies: &cookie.Config{AccessTokenCookieName: "__hOsT-ACCESS", Path: "/auth"}, wantError: "Path=/"},
		{name: "mixed-case host refresh scoped path", cookies: &cookie.Config{RefreshTokenCookieName: "__hOsT-REFRESH"}, wantError: "root path"},
